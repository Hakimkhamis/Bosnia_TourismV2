...
import com.coupne.bosniaguide.R;
...
public class MyViewPager extends PagerAdapter {
    ...
    */
    ...
    private int getImageAt(int position) {
        switch (position) {
            case 0:
                return R.drawable.mostar;
            case 1:
                return R.drawable.banjaluck;
            case 2:
                return R.drawable.bihac;
            case 3:
                return R.drawable.tuzla;
            default:
                return R.drawable.sarajevo;
        }
    }
}